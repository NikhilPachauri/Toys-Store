...
<head>
    ...
    <title>Terms & Conditions - ToyStore</title>
    <style>
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <p>By using our website, you agree to the following Terms & Conditions:</p>
            <ul>
                <li>You must be at least 18 years old to make a purchase.</li>
                <li>All prices are in Indian Rupees and are subject to change.</li>
