...
<head>
    ...
    <title>Shipping Info - ToyStore</title>
    <style>
...
<body>
    <header>
        <div class="navbar">
            ...
            <nav>
                ...
                <a href="shipping-info.php">Shipping Info</a>
    ...
    <div class="container">
        ...
        <div class="content">
            <p>We offer fast and reliable shipping to all locations. Most orders are processed within 1-2 business days and delivered within 3-7 business days.</p>
            <p>Shipping costs are calculated at checkout based on your location and order size.</p>
            <p>For international orders, please allow additional time for customs clearance.</p>
        </div>
    </div>
