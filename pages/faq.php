...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Simply add items to your cart and proceed to checkout.</p>

            <h2>What payment methods do you accept?</h2>
            <p>We accept all major credit cards, debit cards, and online payment gateways.</p>

            <h2>How long does shipping take?</h2>
            <p>Shipping times vary by location, but most orders are delivered within 3-7 business days.</p>

            <h2>Can I return an item?</h2>
            <p>Yes, please see our Return Policy for details.</p>
        </div>
    </div>
